...
public class Post {
    ...
    public String handleRequest(@RequestParam(value="editorTitle") String title, @RequestParam(value="editorAuthor") String author,
        ...
        com.feilong.blog.dao.Blog blog = new com.feilong.blog.dao.Blog(title, value, preview, author, category, date);

        //com.feilong.blog.dao.Blog hasBlog = blogDao.getByTitle(title);
